...
DESCRIPTIONS = {
    ...
    'river-rail': 'Masonry street fronts, slate-colored roofs, cornices and clock towers give the town a late nineteenth-century appearance. The bridge, railway station, post office and river landing join the settlement. The mine gains a taller timber winding frame and a steam boiler.',
    'industrial': 'Brick workshops, steel details, service yards and electrical equipment mark the 1908 industrial town. The power house and fire station retain clear service identities. The mine changes to a metal headframe and a brick power house.',
    ...
    'motor-age': 'The 1932 town uses cream walls, teal canopies, roadside service bays, a bus station and a diner. Gardens soften the growing streets. The mine control house receives a projecting service canopy.',
...
for era in ERAS:
    ...
    lines = [f"# {data['year']} · {data['label']}", '', '[Back to the era visual guide](Era-Visual-Guide.md)', '', DESCRIPTIONS[era], '',
             ...
             'These are actual game meshes rendered in a neutral review scene. Name labels sit outside the model so the architecture remains clear. World scenery, traffic, construction scaffolds and unfinished plots are excluded from these building comparisons.', '', '## Buildings', '']
    for b in data['buildings']:
        ...
        lines += [f"### {b['name']}", '', f"![{b['name']} — {data['label']} upgrade comparison]({prefix}/comparison.png)", '',
