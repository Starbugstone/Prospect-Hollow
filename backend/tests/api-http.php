...
$probe=file_get_contents($origin.'/api/health?check=packaged');
if(json_decode($probe,true)!==['status'=>'ok'])throw new RuntimeException('Release readiness routing failed.');
